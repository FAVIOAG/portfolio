...
<>
      ...
      <div className='cardW'>
        ...
        <p className='cardP'>
          ...
          lectura y mantenimiento para poder construir un verdadero proyecyo en
          equipo!
        </p>
      </div>
      ...
      <div className='cardW'>
        ...
        <p className='cardP'>
          ...
          continua en lenguajes, frameworks y buenas practicas son fundamentales
          para progresar. Priorizando diferentes formas de aprendizaje, con lo
          cual creo que, no solo se adquiere conocimiento de documentacion sino
          fudamentalmente de colegas y abriendome a aprender de los demas!
        </p>
      </div>
      </div>
      </>
